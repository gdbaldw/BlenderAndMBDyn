...
if "bpy" in locals():
    ...
    from mbdyn.base import bpy, Props, TreeMenu, Operators, UI, database, category, root_dot
    from mbdyn import element
    from mbdyn import drive
    from mbdyn import driver
    from mbdyn import friction
    from mbdyn import shape
    from mbdyn import function
    from mbdyn import ns_node
    from mbdyn import constitutive
    from mbdyn import matrix
    from mbdyn import frame
